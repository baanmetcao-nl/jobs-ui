                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {job.tags.map((tag: string) => (
                                    <Badge
                                        key={tag}
                                        className="bg-[#E6F4F1] text-[#3FAFA1]"
                                    >
                                        {tag}
                                    </Badge>
                                ))}
                        ...
                        <div className="mb-8">
                            ...
                            <div className="prose max-w-none text-gray-700">
                                ...
                                <ul>
                                    <li>
                                        <strong>
                                            Extra beloning (bijv. 13e maand,
                                            vaste eindejaarsuitkering, vaste
                                            toelage):
                                        </strong>{' '}
                                        {job.benefits.extraFixedPayment
                                            ? 'Ja'
                                            : 'Nee'}
                                    </li>
                                    <li>
                                        <strong>
                                            Prestatiegebonden beloning (bijv.
                                            variabele uitkering,
                                            prestatiebeloning, winstuitkering):
                                        </strong>{' '}
                                        {job.benefits.extraVariablePayment
                                            ? 'Ja'
                                            : 'Nee'}
                                    </li>
                                    <li>
                                        <strong>Pensioen:</strong>{' '}
                                        {job.benefits.pensionPlan
                                            ? 'Ja'
                                            : 'Nee'}
                                    </li>
                                    <li>
                                        <strong>Reiskostenvergoeding:</strong>{' '}
                                        {job.benefits.travelAllowance
                                            ? 'Ja'
                                            : 'Nee'}
                                    </li>
                                    <li>
